...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `orders_macs_id_fk` FOREIGN KEY (`mac_id`) REFERENCES `macs` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2025-11-15 18:26:03
